...
::google::protobuf::internal::SCCInfo<10> scc_info_Message =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 10, InitDefaultsMessage}, {
      &protobuf_message_2eproto::scc_info_Node.base,
