...
{
template <>
::message::AddToHashTable *Arena::CreateMaybeMessage<::message::AddToHashTable>(Arena *);
template <>
::message::AddToHashTable_HashMapEntry_DoNotUse *Arena::CreateMaybeMessage<::message::AddToHashTable_HashMapEntry_DoNotUse>(Arena *);
template <>
::message::AllStateUpdate *Arena::CreateMaybeMessage<::message::AllStateUpdate>(Arena *);
template <>
::message::DeleteNode *Arena::CreateMaybeMessage<::message::DeleteNode>(Arena *);
template <>
::message::GetVal *Arena::CreateMaybeMessage<::message::GetVal>(Arena *);
template <>
::message::GetValResponse *Arena::CreateMaybeMessage<::message::GetValResponse>(Arena *);
template <>
::message::Join *Arena::CreateMaybeMessage<::message::Join>(Arena *);
template <>
::message::JoinMe *Arena::CreateMaybeMessage<::message::JoinMe>(Arena *);
template <>
::message::List *Arena::CreateMaybeMessage<::message::List>(Arena *);
template <>
::message::Message *Arena::CreateMaybeMessage<::message::Message>(Arena *);
template <>
::message::Node *Arena::CreateMaybeMessage<::message::Node>(Arena *);
template <>
::message::RequestRoutingEntry *Arena::CreateMaybeMessage<::message::RequestRoutingEntry>(Arena *);
template <>
::message::Response *Arena::CreateMaybeMessage<::message::Response>(Arena *);
template <>
::message::ResponseLeafSet *Arena::CreateMaybeMessage<::message::ResponseLeafSet>(Arena *);
template <>
::message::ResponseNeighbourSet *Arena::CreateMaybeMessage<::message::ResponseNeighbourSet>(Arena *);
template <>
::message::ResponseRoutingEntry *Arena::CreateMaybeMessage<::message::ResponseRoutingEntry>(Arena *);
template <>
::message::RoutingUpdate *Arena::CreateMaybeMessage<::message::RoutingUpdate>(Arena *);
template <>
::message::RoutingUpdate_RoutingEntry *Arena::CreateMaybeMessage<::message::RoutingUpdate_RoutingEntry>(Arena *);
template <>
::message::SetVal *Arena::CreateMaybeMessage<::message::SetVal>(Arena *);
template <>
::message::ShutDown *Arena::CreateMaybeMessage<::message::ShutDown>(Arena *);
} // namespace protobuf
} // namespace google
namespace message
{
...
inline const ::message::List &RoutingUpdate_RoutingEntry::nodelist() const
{
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::message::List *>(&::message::_List_default_instance_);
}
...
inline const ::message::Node &GetVal::node() const
{
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::message::Node *>(&::message::_Node_default_instance_);
}
